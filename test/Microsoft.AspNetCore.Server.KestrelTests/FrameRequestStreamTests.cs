...
namespace Microsoft.AspNetCore.Server.KestrelTests
{
    public class FrameRequestStreamTests
    {
        ...
        [Fact]
        public void StopAcceptingReadsCausesReadToThrowObjectDisposedExcpetion()
        {
            var stream = new FrameRequestStream();
            stream.StartAcceptingReads(null);
        ...
        [Fact]
        public void StopAcceptingReadsCausesCopyToAsyncToThrowObjectDisposedExcpetion()
        {
            var stream = new FrameRequestStream();
            stream.StartAcceptingReads(null);
            stream.StopAcceptingReads();
        ...
        [Fact]
        public void ZeroBufferSizeCausesCopyToAsyncToThrowArgementException()
        {
            var stream = new FrameRequestStream();
            stream.StartAcceptingReads(null);
